...
# ------------------------------
st.set_page_config(page_title="🎧 Mental Health Music Recommender", layout="wide")
st.title("🎧 Mental Health Music Recommender")
...
def recommend_genres(df, condition, severity, top_n=3):
    ...
    # Optional: Always include Pop and Rock
    for staple in ['Frequency [Pop]', 'Frequency [Rock]']:
        if staple not in top_genres:
            top_genres.append(staple)
